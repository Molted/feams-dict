  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?= base_url()?>/user/<?= esc($user_details['username'])?>" class="d-block"><?= ucwords(strtolower(esc($user_details['first_name'])))?> <?= ucwords(strtolower(esc($user_details['last_name'])))?></a>
        </div>
      </div>
