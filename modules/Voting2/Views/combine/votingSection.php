<form action="<?= base_url('votes2/cast')?>" method="post" id="voting">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <?php if(!empty($candidate['photo'])):?>
                                        <img src="<?= base_url('public/uploads/candidates')?>/<?= esc($candidate['photo'])?>" alt="..." class="img-thumbnail" style="height: 200px; width: 200px;">
                                    <?php elseif(!empty($candidate['profile_pic'])):?>
                                        <img src="<?= base_url('public/uploads/profile_pic')?>/<?= esc($candidate['profile_pic'])?>" alt="..." class="img-thumbnail" style="height: 200px; width: 200px;">
                                    <?php else:?>
                                        <img src="<?= base_url('public/img')?>/blank.jpg" alt="..." class="img-thumbnail" style="height: 200px; width: 200px;">
                                    <?php endif;?>
                                </div>
                                <div class="col-md-6">
                                  <dl class="row">
