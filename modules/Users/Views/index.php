        ...
        <tbody>
            ...
            <?php foreach($users as $user): ?>
                <tr>
                    ...
                    <td scope="row"><?= esc(ucwords(strtolower($user['first_name'])))?> <?= esc(ucwords(strtolower($user['last_name'])))?></td>
                    ...
                    <td scope="row">
                      <?php
                        switch(esc($user['type'])) {
                          case '1': echo 'Regular';
                          break;
                          case '2': echo 'Part-time';
                          break;
                          case '3': echo 'Admin';
                          break;
                        }
                    ...
                    <td scope="row">
                      ...
                      <?= empty($user['proof']) ? 'No membership proof' : '<a href="'.base_url().'/public/uploads/proof/'.esc($user['proof']).'" target="_blank">View Membership</a>'?>
                    </td>
                    <td scope="row">
                        <?php 
