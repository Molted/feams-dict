...
<div class="row mb-2">
    <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('admin/electoral-positions');?>">Electoral Positions</a></li>
...
<div class="card card-light">
    <div class="card-body">
      <div class="form-group"> <!-- Position Name -->
        ...
        <input type="text" class="form-control <?=isset($errors['position_name']) ? 'is-invalid': ''?>" id="name" name="position_name" value="<?=isset($value['position_name']) ? esc($value['position_name']): ''?>">
        <?php if(isset($errors['position_name'])):?>
            <div class="invalid-feedback">
                <?=esc($errors['position_name'])?>
            </div>
        <?php endif;?>
      </div>
  ...
  $(document).ready(function ()
  {
    $('.sub').click(function (e)
    {
      ...
      Swal.fire({
        icon: 'question',
        title: 'Add?',
        text: 'Are you sure to add electoral position?',
